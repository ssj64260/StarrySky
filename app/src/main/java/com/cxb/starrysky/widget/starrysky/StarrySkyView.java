    ...
    public StarrySkyView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        points = new Point[][]{
                ...
                },
                {
                        ...
                        new Point(mCenterViewWidthPX * 2 - mAroundViewWidthPX, -mCenterViewHeightPX),
                        new Point(-mCenterViewWidthPX, (mCenterViewHeightPX - mAroundViewHeightPX) / 2),
                        new Point((mCenterViewWidthPX * 3 - mAroundViewWidthPX) / 2, 0),
                        ...
                        new Point(-mAroundViewWidthPX, mCenterViewHeightPX * 2),
                        new Point((mCenterViewWidthPX * 3 - mAroundViewWidthPX) / 2, (mCenterViewHeightPX * 5 - mAroundViewHeightPX) / 2)
                },
                {
                        new Point(-(mCenterViewWidthPX + mAroundViewWidthPX) / 2, -(mCenterViewHeightPX + mAroundViewHeightPX)),
                        new Point(mCenterViewWidthPX * 2 - mAroundViewWidthPX, -(mCenterViewHeightPX + mAroundViewHeightPX)),
                        new Point(mCenterViewWidthPX - mAroundViewWidthPX, -(mCenterViewHeightPX + mAroundViewHeightPX) / 2),
                        new Point(mCenterViewWidthPX * 2 - mAroundViewWidthPX, -(mCenterViewHeightPX + mAroundViewHeightPX) / 2),
                        new Point(-mCenterViewWidthPX, mCenterViewHeightPX - mAroundViewHeightPX),
                        new Point((mCenterViewWidthPX * 3 - mAroundViewWidthPX) / 2, (mCenterViewHeightPX - mAroundViewHeightPX) / 2),
                        new Point(-mCenterViewWidthPX, mCenterViewHeightPX * 2 - mAroundViewHeightPX),
                        new Point(mCenterViewWidthPX - mAroundViewWidthPX, mCenterViewHeightPX * 2 - mAroundViewHeightPX),
                        new Point(-mAroundViewWidthPX, (mCenterViewHeightPX * 5 - mAroundViewHeightPX) / 2),
                        new Point((mCenterViewWidthPX * 3 - mAroundViewWidthPX) / 2, mCenterViewHeightPX * 3 - mAroundViewHeightPX)
                }
        };
